...
#define MOTOR_MAX_RPM 205                   // motor's max RPM
...
#define COUNTS_PER_REV1 2140              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 2078              // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 2219              // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 2263              // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.097                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.265            // distance between left and right wheels
